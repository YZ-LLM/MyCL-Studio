...
export type AgentAction =
  ...
  | "verify_feature"
  /** 2026-07-16: 🔧 Bakım Turu — "bağımlılıkları güncelle / bakım yap / paketleri
   *  yenile" niyeti. YALNIZ onay askq'ı açar (bağımlılık YAZAR); koşum kullanıcı
   *  onayından sonra. Parametre taşımaz; state.current_phase değiştirmez. */
  | "run_maintenance"
  /** Agent emin değil → classifier YOK; kullanıcıya görünür bir "anlayamadım,
   *  tekrar yazar mısın" mesajı döner (index.ts). */
