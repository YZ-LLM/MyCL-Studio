// phase-9-debate-review — Faz 9 çok-ajanlı "bulan + çürüten" risk incelemesi (Ümit 2026-06-13).
//
...
// döner (kullanıcı onayı YOK — Ümit "kendisi en iyisini bulsun"). Çıktı risk-fix dispatch'ine akar.
//
...
/** phase-09-risk.md'nin "altı ekseni" — her birine bir uzman bulucu. */
